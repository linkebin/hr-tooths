 ...
 * Licensed under the MIT license */
    function (t, e, n, i) {
        ...
        function M(t, e, n) {
            var i = n.pointers.length, a = n.changedPointers.length, r = e & Ot && i - a === 0,
                o = e & (It | Ht) && i - a === 0;
        ...
        function _(t, e) {
            ...
            var r = n.firstInput, o = n.firstMultiple, s = o ? o.center : r.center, c = e.center = O(i);
        ...
        function O(t) {
            ...
            for (var n = 0, i = 0, a = 0; a < e;) n += t[a].clientX, i += t[a].clientY, a++;
        ...
        function L(t, e) {
            ...
            if (r = n.filter(function (t) {
                return f(t.target, c)
            }), e === Ot) for (a = 0; a < r.length;) i[r[a].identifier] = !0, a++;
        ...
        var wt = s(function (t, e, n) {
            ...
            Et = "mouse", Dt = "kinect", Pt = 25, Ot = 1, At = 2, It = 4, Ht = 8, St = 1, Yt = 2, Vt = 4, Nt = 8,
            Ft = 16, Rt = Yt | Vt, qt = Nt | Ft, zt = Rt | qt, Lt = ["x", "y"], jt = ["clientX", "clientY"];
        C.prototype = {
            handler: function () {
            }, init: function () {
        ...
        var Xt = {mousedown: Ot, mousemove: At, mouseup: It}, $t = "mousedown", Wt = "mousemove mouseup";
        c(N, C, {
            handler: function (t) {
                var e = Xt[t.type];
        ...
        t.MSPointerEvent && !t.PointerEvent && (Bt = "MSPointerDown", Gt = "MSPointerMove MSPointerUp MSPointerCancel"), c(F, C, {
            handler: function (t) {
                ...
                a & Ot && (0 === t.button || o) ? s < 0 && (e.push(t), s = e.length - 1) : a & (It | Ht) && (n = !0), s < 0 || (e[s] = t, this.callback(this.manager, a, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: r,
                    srcEvent: t
        ...
        var Jt = {touchstart: Ot, touchmove: At, touchend: It, touchcancel: Ht}, Zt = "touchstart",
        ...
        c(z, C, {
            handler: function (t) {
                var e = te[t.type], n = L.call(this, t, e);
        ...
        G.prototype = {
            defaults: {}, set: function (t) {
                ...
                return t = Q(t, this), g(e, t) === -1 && (e.push(t), t.requireFailure(this)), this
                ...
                i < ve && e(n.options.event + J(i)), e(n.options.event), t.additionalEvent && e(t.additionalEvent), i >= ve && e(n.options.event + J(i))
            }, tryEmit: function (t) {
            ...
            directionTest: function (t) {
                ...
                return a & e.direction || (e.direction & Rt ? (a = 0 === r ? St : r < 0 ? Yt : Vt, n = r != this.pX, i = Math.abs(t.deltaX)) : (a = 0 === o ? St : o < 0 ? Nt : Ft, n = o != this.pY, i = Math.abs(t.deltaY))), t.direction = a, n && i > e.threshold && a & e.direction
            },
            attrTest: function (t) {
            ...
            defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
                ...
                if (this._input = t, !i || !n || t.eventType & (It | Ht) && !r) this.reset(); else if (t.eventType & Ot) this.reset(), this._timer = a(function () {
            ...
            inputTarget: null,
            inputClass: null,
            preset: [[at, {enable: !1}], [nt, {enable: !1}, ["rotate"]], [rt, {direction: Rt}], [et, {direction: Rt}, ["swipe"]], [ot], [ot, {
                event: "doubletap",
                taps: 2
            }, ["tap"]], [it]],
            cssProps: {
    ...
    var e = function (e, n) {
        ...
        var n = !1, i = t(".weui-toast--visible").removeClass("weui-toast--visible").transitionEnd(function () {
            var i = t(this);
            i.remove(), e && e(), n = !0
        });
        setTimeout(function () {
    ...
    "use strict";
    var e = function (n, i) {
        "function" == typeof i && (i = {onRefresh: i}), "string" == typeof i && (i = void 0), this.opt = t.extend(e.defaults, i || {}), this.container = t(n), this.attachEvents()
    };
    e.defaults = {distance: 50, onRefresh: void 0, onPull: void 0}, e.prototype.touchStart = function (e) {
        ...
        if (!this.container.hasClass("refreshing")) {
            ...
            if (!(this.container.scrollTop() > 0)) {
                var n = t.getTouchPosition(e);
                return this.diffX = n.x - this.start.x, this.diffY = n.y - this.start.y, Math.abs(this.diffX) > Math.abs(this.diffY) || void(this.diffY < 0 || (this.container.addClass("touching"), e.preventDefault(), e.stopPropagation(), this.diffY = Math.pow(this.diffY, .75), this.container.css("transform", "translate3d(0, " + this.diffY + "px, 0)"), this.triggerPull(this.diffY)))
            }
        }
    ...
    if (e.ios = e.android = e.iphone = e.ipad = e.androidChrome = !1, i && (e.os = "android", e.osVersion = i[2], e.android = !0, e.androidChrome = n.toLowerCase().indexOf("chrome") >= 0), (a || o || r) && (e.os = "ios", e.ios = !0), o && !r && (e.osVersion = o[2].replace(/_/g, "."), e.iphone = !0), a && (e.osVersion = a[2].replace(/_/g, "."), e.ipad = !0), r && (e.osVersion = r[3] ? r[3].replace(/_/g, ".") : null, e.iphone = !0), e.ios && e.osVersion && n.indexOf("Version/") >= 0 && "10" === e.osVersion.split(".")[0] && (e.osVersion = n.toLowerCase().split("version/")[1].split(" ")[0]),
        e.webView = (o || a || r) && n.match(/.*AppleWebKit(?!.*Safari)/i), e.os && "ios" === e.os) {
        ...
        return c.setValue = function (t, e) {
            ...
            function r(e) {
                if (y) {
                    ...
                    var i = x - k;
                    E = M + i, _ = void 0, E < v && (E = v - Math.pow(v - E, .8), _ = "min"), E > g && (E = g + Math.pow(E - g, .8), _ = "max"), h.wrapper.transform("translate3d(0," + E + "px,0)"), h.updateItems(void 0, E, 0, c.params.updateValuesOnTouchmove), P = E - D || E, O = (new Date).getTime(), D = E
                }
            }
            ...
            if (!h.divider) {
                ...
                h.setValue = function (e, n, a) {
                    ...
                    if ("undefined" == typeof r || r === -1) return void(h.value = h.displayValue = e);
                    var o = -r * f + g;
                    ...
                    "undefined" == typeof n && (n = t.getTranslate(h.wrapper[0], "y")), "undefined" == typeof e && (e = -Math.round((n - g) / f)), e < 0 && (e = 0), e >= h.items.length && (e = h.items.length - 1);
                    var r = h.activeIndex;
                    ...
                    if ((a || "undefined" == typeof a) && (h.value = o.attr("data-picker-value"), h.displayValue = h.displayValues ? h.displayValues[e] : h.value, r !== e && (h.onChange && h.onChange(c, h.value, h.displayValue), c.updateValue())), c.params.rotateEffect) {
                        ...
                        h.items.each(function () {
                            ...
                            c > 180 && (c = 180), c < -180 && (c = -180), Math.abs(o) > s ? e.addClass("picker-item-far") : e.removeClass("picker-item-far"), e.transform("translate3d(0, " + (-n + g) + "px, " + (p ? -110 : 0) + "px) rotateX(" + c + "deg)")
                        })
                    }
            ...
            if (c.opened && !c.inline) return i() ? void t.closePicker(c.popover) : void t.closePicker(c.container)
        }, c.destroy = function () {
    ...
    var e, n = !1, i = function (t, e) {
        ...
        return p.animating = !1, p.addValue = function (t) {
            ...
            function a(t) {
                return o && s ? (o = s = !1, m = (new Date).getTime(), m - f < 300 ? Math.abs(k) < 10 ? p.resetMonth() : k >= 10 ? n ? p.nextMonth() : p.prevMonth() : n ? p.prevMonth() : p.nextMonth() : T <= -.5 ? n ? p.prevMonth() : p.nextMonth() : T >= .5 ? n ? p.nextMonth() : p.prevMonth() : p.resetMonth(), void setTimeout(function () {
                    C = !0
                }, 100)) : void(o = s = !1)
            }
            ...
            var e = r() && !1, n = !1;
            p.opened || (p.value || p.params.value && (p.value = p.params.value, n = !0), p.layout(), e ? (p.pickerHTML = '<div class="popover popover-picker-calendar"><div class="popover-inner">' + p.pickerHTML + "</div></div>", p.popover = t.popover(p.pickerHTML, p.params.input, !0), p.container = t(p.popover).find(".weui-picker-modal"),
            ...
            if (p.opened && !p.inline) return p.animating = !1, o() ? void t.closePicker(p.popover) : void t.closePicker(p.container)
        }, p.destroy = function () {
    ...
    i.prototype = {
        getDays: function (t) {
            ...
            var t, e = new Date, i = this.params, a = this, r = {
                ...
                cols: [{values: this.initYears}, {
                    divider: !0,
                    content: i.yearSplit
                }, {values: this.initMonthes}, {divider: !0, content: i.monthSplit}, {
                    values: function () {
        ...
        years: function () {
            for (var t = [], e = 2018; e <= 2030; e++) t.push(e);
            return t
        }(),
        times: function () {
            return [{
    ...
    var e, n, i, a, r, o, s = function (n) {
        ...
        e.removeClass("touching"), e.attr("style", ""), o < 0 && Math.abs(o) > .38 * e.height() && t.closeNotification(), Math.abs(r) <= 1 && Math.abs(o) <= 1 && e.trigger("noti-click"), a = !1
    }, u = function (e) {
    ...
    e.prototype.bind = function () {
        ...
        r < 0 && (r = 0), r > 100 && (r = 100), this.handler.css("left", r + "%"), this.track.css("width", r + "%"), this.value.text(r), this.callback && this.callback.call(this, r), this.container.trigger("change", r)
