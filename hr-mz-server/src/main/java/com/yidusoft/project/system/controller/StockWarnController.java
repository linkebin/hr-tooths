...
public class StockWarnController {
    ...
    public Result add(String id,String code,String name,int num) {
        ...
        if(id!=null && !"".equals(id)){
            stockWarn.setId(id);
			stockWarn.setClinicId(secUser.getOrgId());
    ...
    public Result findStockWarn(String code,String typeId,int page,int size) {
        SecUser secUser = Security.getUser();
        List<Map<String,Object>> list = stockWarnService.findStockWarn(secUser.getOrgId(),code,typeId,size,(page-1)*size);
        int count = stockWarnService.findStockWarnCount(secUser.getOrgId(),code,typeId);
    ...
    public void excelStockWarn(HttpServletResponse response) throws Exception {
        ...
        SecUser secUser = Security.getUser();
        List<Map<String,Object>> list = stockWarnService.findStockWarnAll(secUser.getOrgId(),"","");
