...
public interface StockMapper extends Mapper<Stock> {
	...
	List<Stock> findStockList(@Param("typeId") String typeId,@Param("name") String name, @Param("limit") int limit, @Param("page") int page);

	Integer findStockListCount(@Param("typeId") String typeId,@Param("name") String name);
