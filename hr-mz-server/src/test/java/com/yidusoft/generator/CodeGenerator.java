...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/hr_dental";
...
private static final String PROJECT_PATH = "C:\\Users\\linkb\\Desktop\\华仁牙科\\05.开发\\hr-mz-server";//项目在硬盘上的基础路径
