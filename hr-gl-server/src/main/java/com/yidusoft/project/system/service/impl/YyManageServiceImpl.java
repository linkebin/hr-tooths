...
public class YyManageServiceImpl extends AbstractService<YyManage> implements YyManageService {
    ...
    @Override
    public List<Map<String, Object>> todayTanking() {
        return yyManageMapper.todayTanking();
    }

    @Override
    public List<Map<String, Object>> monthTanking(String starTime, String endTime) {
        return yyManageMapper.monthTanking(starTime,endTime);
    }

    @Override
    public int patients() {
        Integer num = yyManageMapper.patients();
        if(num == null){
            return 0;
        }else{
            return num;
