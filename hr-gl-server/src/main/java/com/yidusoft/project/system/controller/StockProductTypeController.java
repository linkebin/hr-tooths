...
public class StockProductTypeController {
    ...
    public Result add(String json) {
        ...
        stockProductType.setCode(CodeHelper.getCode("CD"));
    ...
    public Result treeInfo(String pId, int size, int page) {
        SecUser secUser = Security.getUser();
        List<StockProductType> list = stockProductTypeService.getProductType("122",pId,size,(page-1)*size);
        int count = stockProductTypeService.getProductTypeCount("122",pId);
