...
public class ShiroConfigurer {
   ...
   /* @Bean
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager){
        ...
        shiroFilterFactoryBean.setLoginUrl("/login/loginOut");
//        shiroFilterFactoryBean.setLoginUrl("/loginAgain");
        // 登录成功后要跳转的链接
        //shiroFilterFactoryBean.setSuccessUrl("/");
        //未授权界面;
        shiroFilterFactoryBean.setUnauthorizedUrl("/login/unAuthority");
        //拦截器.
        Map<String,String> filterChainDefinitionMap = new LinkedHashMap<String,String>();

        //配置退出 过滤器,其中的具体的退出代码Shiro已经替我们实现了
        filterChainDefinitionMap.put("/logout", "logout");
        filterChainDefinitionMap.put("/login/authorize","anon");
        filterChainDefinitionMap.put("/upload/**","anon");
//        filterChainDefinitionMap.put("/sec/user/list","anon");
