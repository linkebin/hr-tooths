...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://192.168.1.35:3306/base_frame";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";

//    private static final String PROJECT_PATH = System.getProperty("user.dir");//项目在硬盘上的基础路径
//    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH +"/resources/generator/template";//模板位置

private static final String PROJECT_PATH = "D:\\yidusoft项目\\08后台管理系统\\hr-gl-server";//项目在硬盘上的基础路径
    ...
    public static void main(String[] args) {
        //  genCode("sec_menu","sec_menu_member","sec_menu_role","sec_org","sec_role","sec_role_member","sec_user");
        genCode("behavior_log","notice_administration","sec_menu","sec_menu_member","sec_menu_role","sec_org","sec_role","sec_user","sys_message");
    ...
    public static void genService(String tableName) {
        try {
            ...
            data.put("basePackage", BASE_PACKAGE+".project.system");
