...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        autoFilter: false,                    //自动生成高级查询, 需要filter/toolbar组件支持. 需要引用skins/ligerui-iconStyle2.css
...
(function ($)
{
    ...
    $.ligerui.controls.Panel.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            g.panel.append('<div class="l-panel-header"><span></span><div class="iconStyle2"></div></div><div class="l-panel-content"></div>');
        ...
        _setShowToggle:function(v)
        {
            ...
            if (v)
            {
                ...
                toggle.appendTo(header.find(".iconStyle2"));
                toggle.attr("title", p.collapseMessage);
            } else
            {
        ...
        _setShowClose: function (v)
        {
            ...
            if (v)
            {
                ...
                btn.appendTo(header.find(".iconStyle2"));
