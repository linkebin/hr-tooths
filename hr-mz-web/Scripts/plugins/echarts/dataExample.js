        ...
        itemStyle: {
            normal: {
                ...
                color:new echarts.graphic.LinearGradient(0,0,0,1,[{
                    offset: 0,
                    color: 'rgba(0,250,202,0.7)'
                },{
                    offset:1,
                    color:'rgba(31,131,214,0.7)'
            ...
            emphasis: {
                shadowBlur: 50,
                shadowColor: 'rgba(31,131,214,0.3)'
            }
        },
       ...
       /* title: {
        ...
        series: [
            ...
            },
            {
                ...
                type:'line',
                smooth: false,
                symbolSize: [10,10], // 空心圆的半径
                data:[11, 10, 11, 12, 12, 10, 13],
                itemStyle : {
                    normal : {
                        color:'#fff442',
                        lineStyle:{
...
// 地图
var myChart = echarts.init(document.getElementById('chart6'),'macarons');
