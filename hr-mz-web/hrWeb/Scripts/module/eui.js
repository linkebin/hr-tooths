...
;!function(e){"use strict";
    var t=document,
        ...
        a = function(t){
            e.console && console.error && console.error("eui hint: " + t)
        },
        ...
        u={
            ...
            //扩展模块-----start------
            idCode:"mymod/idCode",     //验证码
            elementExtend:"mymod/elementExtend",     //其它元素扩展

        //   testFun:"mymod/testFun",
        //    definedForm:"../base/definedForm",
        //    jqueryUi:"modules/jquery-ui",
        //    jqueryUi:"../../libs/jquery-ui/jquery-ui",

            //扩展模块-----end------

             "eui.all":"dest/eui.all"
        };
            n.prototype.cache=o,
            n.prototype.define = function(e, t) {
                ...
                return r && (t = e, e = []),
                    eui["eui.all"] || !eui["eui.all"] && eui["eui.mobile"] ? a.call(n) : (n.use(e, a), n)
            },
                n.prototype.use = function(e, n, l) {
                    function s(e, t) {
                        var n = "PLaySTATION 3" === navigator.platform ? /^complete$/: /^(complete|loaded)$/; ("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.modules[f] = t, d.removeChild(v),
                            function r() {
                    ...
                    function c() {
                        l.push(eui[f]),
                            e.length > 1 ? y.use(e.slice(1), n, l) : "function" == typeof n && n.apply(eui, l)
                    }
                    var y = this,
                    ...
                    window.jQuery && jQuery.fn.on && (y.each(e,
                        ...
                        }), eui.jquery = eui.$ = jQuery);
                    var f = e[0],
                        m = 0;
                    if (l = l || [], o.host = o.host || (p.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length || eui["eui.all"] && u[f] || !eui["eui.all"] && eui["eui.mobile"] && u[f]) return c(),
                        y;
                    if (o.modules[f]) !
                        function g() {
                        ...
                        var v = t.createElement("script"),
                            h = (u[f] ? p + "EUI/": o.base || "") + (y.modules[f] || f) + ".js";
                        v.async = !0,
                            v.charset = "utf-8",
                            v.src = h +
                                function() {
                ...
                n.prototype.addcss = function(e, t, n) {
                    return eui.link(o.dir + "../../Styles/themes/default/" + e, t, n)
                },
                ...
                n.prototype.router=function(e){
                    ...
                    return/^#\//.test(e)?(e=e.replace(/^#\//,"").replace(/([^#])(#.*$)/,"$1").split("/")||[],
                        t.each(e,function(e,t){/^\w+=/.test(t)?function(){t=t.split("="),o.search[t[0]]=t[1]}():o.path.push(t)}),o):o
                },
                n.prototype.data=function(t,o){
                    if(t=t||"eui",e.JSON&&e.JSON.parse){
                ...
                n.prototype.sort=function(e,t,o){
                    ...
                    return t?(n.sort(function(e,o){
                        var n=/^\d+\d+\d$/,r=e[t],a=o[t];
                        return n.test(r)&&(r=parseFloat(r)),
                        n.test(a)&&(a=parseFloat(a)),r>a?1:r<a?-1:0
                    }),o&&n.reverse(),n):n},
                ...
                n.prototype.event=function(e,t,n){
                    var r=this,
                        a=null,
                        i=t.match(/\(.*\)$/)||[],u=(t=e+"."+t).replace(i,""),
                        l=function(e,t){
                            var o=t&&t.call(r,n);o===!1&&null===a&&(a=!1)
                        };
                    return eui.each(o.event[u],l),i[0]&&eui.each(o.event[t],l),a
                },
                e.eui=new n
}(window);