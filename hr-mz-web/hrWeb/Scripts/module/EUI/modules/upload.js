        ...
        f.prototype.config = {
            ...
            f.prototype.file = function() {
                var e = this,
                    ...
                    a = t.elem.next(); (a.hasClass(r) || a.hasClass(u)) && a.remove(),
                n.ie && n.ie < 10 && t.elem.wrap('<div class="eui-upload-wrap"></div>'),
                    e.isFile() ? (e.elemFile = t.elem, t.field = t.elem[0].name) : t.elem.after(o),
                n.ie && n.ie < 10 && e.initIE()
            },
            f.prototype.initIE = function() {
                ...
                i("#" + c)[0] || i("body").append(n),
                t.elem.next().hasClass(c) || (e.elemFile.wrap(o), t.elem.next("." + c).append(function() {
                    var e = [];
                    return eui.each(t.data,
                        function(i, t) {
            ...
            f.prototype.preview = function(e) {
                var i = this;
                window.FileReader && eui.each(i.chooseFiles,
                    function(i, t) {
            ...
            f.prototype.upload = function(e, t) {
                var o, a = this,
                    ...
                    r = a.elemFile[0],
                    u = function() {
                        eui.each(e || a.files || a.chooseFiles || r.files,
                            function(e, t) {
                                var n = new FormData;
                                n.append(l.field, t),
                                    eui.each(l.data,
                    ...
                    h = function() {
                        var i = [];
                        return eui.each(e || a.chooseFiles,
                            function(e, t) {
                                i.push(t.name)
                            }),
                            i
                ...
                switch (h = 0 === h.length ? r.value.match(/[^\/\\]+\..+/g) || [] || "": h, l.accept) {
                    case "file":
                        if (v && !RegExp("\\w\\.(" + v + ")$", "i").test(escape(h))) return a.msg("选择的文件中包含不支持的格式"),
                            r.value = "";
                        break;
                    case "video":
                        if (!RegExp("\\w\\.(" + (v || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(escape(h))) return a.msg("选择的视频中包含不支持的格式"),
                            r.value = "";
                        break;
                    case "audio":
                        if (!RegExp("\\w\\.(" + (v || "mp3|wav|mid") + ")$", "i").test(escape(h))) return a.msg("选择的音频中包含不支持的格式"),
                            r.value = "";
                        break;
                    default:
                        if (eui.each(h,
                                function(e, i) {
                                    //    RegExp("\\w\\.(" + (v || "jpg|png|gif|bmp|jpeg$") + ")", "i").test(escape(i)) || (o = !0)
                                        RegExp("\\S\\.(" + (v || "jpg|png|gif|bmp|jpeg$") + ")", "i").test(escape(i)) || (o = !0)
                                }), o) return a.msg("选择的图片中包含不支持的格式"),
                            r.value = ""
                }
                return l.size > 0 && !(n.ie && n.ie < 10) ? eui.each(a.chooseFiles,
                    function(e, i) {
            ...
            f.prototype.events = function() {
                var e = this,
                    ...
                    a = function(i, n) {
                        ...
                        e.isFile() || t.choose || o.after('<span class="eui-inline ' + s + '">' + a + "</span>")
                    };
                t.elem.off("upload.start").on("upload.start",
                    function() {
                        e.elemFile[0].click()
                    }),
                n.ie && n.ie < 10 || t.elem.off("upload.over").on("upload.over",
                    function() {
                        var e = i(this);
                        e.attr("e-over", "")
                    ...
                    function(n, l) {
                        var r = i(this),
                            u = l.originalEvent.dataTransfer.files || [];
                        r.removeAttr("e-over"),
                            o(u),
                            t.auto ? e.upload(u) : a(u)
                    }),
                    e.elemFile.on("change",
                        function() {
                            var i = this.files || [];
                            o(i),
                                t.auto ? e.upload() : a(i)
                ...
                t.elem.data("haveEvents") || (t.elem.on("click",
                    function() {
